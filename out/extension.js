...
async function activate(context) {
    ...
    // 📊 Reportes
    const reportsProvider = new uavController_1.FolderViewProvider(outputDir, 'html|pdf', (0, i18n_1.localize)('ui.reportsView.label', 'Reports')); // Localized string
    vscode.window.registerTreeDataProvider('uav.reportsView', reportsProvider);
    // 🪵 Logs
    const logsProvider = new uavController_1.FolderViewProvider(logDir, 'log', (0, i18n_1.localize)('ui.logsView.label', 'Logs')); // Localized string
